<script lang="ts">
	...
	function submit() {
		...
		addVendor(f);
		toast.success(`Vendor ${f.nama} ditambahkan`, { description: 'Tersedia untuk Admin Travel.' });
		f = { nama: '', kategori: '', kontak: '', rating: 4 };
		errors = {};
	}
</script>

<svelte:head><title>Vendor Management — Astronova</title></svelte:head>

<PageHeader
	supertitle="Super Admin / Sistem"
	title="Vendor Management"
	desc="Pusat data maskapai, hotel, agen tiket, dan transportasi lokal."
/>
	...
	<Card class="self-start">
		...
		>
			...
			<div class="flex justify-end">
				<Button type="submit"><Building2 size={15} /> Tambah Vendor</Button>
			</div>
		</form>
	</Card>
